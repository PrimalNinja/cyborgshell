...
function cyborgShell_API(objGlobals_a)
{
	var m_objThis = this;
	...
	{
		globals.console.errorOutput(strError_a);
	};
	
	this.input = function(strDefault_a, cb_a)
	{
		globals.console.input(strDefault_a, cb_a);
	};
	...
	{
		globals.console.handleServerCommands('language', 0, function(objResponse_a)
		{
			if (isFunction(cb_a))
			{
				cb_a(objResponse_a);
	...
	{
		globals.console.handleServerCommands('languages', 0, function(objResponse_a)
		{
			if (isFunction(cb_a))
			{
				cb_a(objResponse_a);
	...
	{
		globals.console.deleteLocalData(strFilename_a, function(blnResponse_a)
		{
			if (isFunction(cb_a))
			{
				cb_a(blnResponse_a);
	...
	{
		globals.console.loadLocalData(strFilename_a, function(objResponse_a)
		{
			if (isFunction(cb_a))
			{
				cb_a(objResponse_a);
	...
	{
		globals.console.saveLocalData(strFilename_a, objData_a, function(blnResponse_a)
		{
			if (isFunction(cb_a))
			{
				cb_a(blnResponse_a);
